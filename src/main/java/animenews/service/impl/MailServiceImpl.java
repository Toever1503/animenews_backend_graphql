...
public class MailServiceImpl implements IMailService {
    ...
    private final String mailTemplateFolder = "/mail-template/";

    Logger mailLogger = LoggerFactory.getLogger(IMailService.class);
    ...
    public void  sendMail(String template, String to, String subject, Map<String, Object> content) throws MessagingException {
        ...
        String contentHtml = templateEngine.process(this.mailTemplateFolder + template, context);
